        ...
        <form onSubmit={saveCourse}>
            <div>
                ...
                <div class="field">
                    ...
                    <div class="control">
                        <input class="input" type="text" placeholder="Text input" onChange={(e) => setTrainerId(e.target.value)}/>
                    </div>
                </div>
                ...
                <div class="field">
                    ...
                    <div class="control">
                        <input class="input" type="text" placeholder="e.g" onChange={(e) => setDesc(e.target.value)}/>
                    </div>
                </div>
